...
function Get-KnownFolderPath {
    <#
        .SYNOPSIS
            Function for calling folder path by name.
        .DESCRIPTION
            Defines all folder path's GUIDs and queries the location of said folder.
        .EXAMPLE
            Get-KnownFolderPath "Desktop"

            This example gets the full path of the system desktop.
        .INPUTS
            None.
        .OUTPUTS
            [System.Object]
    ...
    $folderGuid = $knownFolders.$("$folder")
...
"@
    ...
    $result = $([shell32]::GetKnownFolderPath("{$($folderGuid)}"))
    "$result"
}
...
Export-ModuleMember -Function Get-KnownFolderPath
