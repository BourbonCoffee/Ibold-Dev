<##
        ...
        Required - Thumbprint of the certificate generated from the Create-CAPReportApplication.ps1 script    
    #>
...
##File Location
$FilePath = "$([Environment]::GetFolderPath('Desktop'))\CAP Assessment"
Try {
    ...
    Write-Host "Could not create folder on your desktop - check you have appropriate permissions" -ForegroundColor red
    exit
}
